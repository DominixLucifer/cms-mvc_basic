    <div class="main-menu-content menu-accordion">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            <li class="active"><a href="index.php?route=admin"><i class="ft-home"></i><span class="menu-title" data-i18n="">Stack Admin</span></a>
            </li>
           
            <li class="nav-item"><a href="#"><i class="fas fa-user-cog"></i><span class="menu-title" data-i18n="">Profile</span></a>
                <ul class="menu-content">
                    <li><a class="menu-item" href="index.php?route=admin-profile"><i class="fas fa-user-edit"></i> Profile config</a>
                    </li>
                    <li><a class="menu-item" href="index.php?route=admin-user"><i class="fas fa-concierge-bell"></i> Add user</a>
                    </li>
                </ul>
            </li>
